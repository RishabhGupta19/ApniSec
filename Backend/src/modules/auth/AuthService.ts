...
import { RegisterInput, AuthRegisterResult } from "../../types";
...
export class AuthService {
   ...
   */
 async register(data: RegisterInput): Promise<AuthRegisterResult> {
   ...
   */
  async login(email: string, password: string): Promise<AuthRegisterResult> {
